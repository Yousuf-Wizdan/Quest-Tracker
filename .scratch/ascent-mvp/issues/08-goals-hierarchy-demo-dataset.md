# 08 — Goals hierarchy + demo dataset

**What to build:** The Goal → Area → Project → Quest → Step hierarchy, persisted and surfaced on the Goals screen, with a seeded demo hierarchy that matches the design.
